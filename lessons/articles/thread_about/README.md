...
Еще одно ключевое различие между двумя стандартами заключается в том, что Thread не определяет конкретные уровни приложений, в то время как Zigbee определяет все уровни в модели OSI. Это делает Thread более гибким выбором с точки зрения выбора прикладного уровня. С другой стороны, Zigbee гарантирует большую совместимость на прикладном уровне.    
Существуют также некоторые различия в процессе аутентификации между двумя протоколами.    
